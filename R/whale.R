#' Ohwhaley help
#'
#' @description You are talking to a whale. Think about that.
#'
#' @param what text string; This is what you want the whale to say. If not supplied, a random phrase is chosen.
#'
#' @return Text string
#' @export
#'
#' @examples
#' say("Whale-come to ohwhaley!")
say <- function(what){
